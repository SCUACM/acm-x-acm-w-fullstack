...
In this part of the workshop, set up your own Flask server and integrate it with your React front end from the previous workshop. [Workshop Slides]([ACM-W 2026 API + Flask Workshop.pdf](https://github.com/SCUACM/acm-x-acm-w-fullstack/blob/1-21-api/ACM-W%202026%20API%20%2B%20Flask%20Workshop.pdf))
